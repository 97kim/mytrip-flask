    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            for (let i = 0; i < bookmarks.length; i++) {
                ...
                let file = JSON.parse(sessionStorage.getItem('near_object'))[content_id]['file'];
                let address = JSON.parse(sessionStorage.getItem('near_object'))[content_id]['address'];
                let distance = JSON.parse(sessionStorage.getItem('near_object'))[content_id]['distance'];
                ...
                $('#bookmark_card').append(temp_html);
                slide();
            }
        }
    });
